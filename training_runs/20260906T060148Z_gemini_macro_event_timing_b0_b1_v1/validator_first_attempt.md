...
| OOF predictions | FAIL | six fold models + OOF arrays | failed: each fold has distinct preceding-history B0/B1 models | regenerate genuine fold-held-out predictions |
...
Correct only listed validation methodology failures in a new preserved run; do not tune.
